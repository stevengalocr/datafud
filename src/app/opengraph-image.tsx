...
export const alt = `DataFud: tu carta digital con QR, lista en ${PRICING.delivery.menuHours} horas hábiles`;
export const size = OG_SIZE;
export const contentType = OG_CONTENT_TYPE;

export default function Image() {
  return ogImage({
    title: `Tu carta digital con QR, lista en ${PRICING.delivery.menuHours} horas hábiles`,
