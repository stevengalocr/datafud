...
|---|---|---|---|---|
| `demo/platos/p-gallo.webp` | Gallo Pinto con huevo | new perspectives | <https://www.pexels.com/photo/37347242/> (recorte del plato de arriba) | Pexels |
...
| `demo/platos/p-hamburguesa.webp` | Hamburguesa Casera | sk (@rollelflex_graphy726) | <https://unsplash.com/photos/uVPV_nV17Tw> | Unsplash |
...
| `demo/portada.webp` | Portada del local de la demo | Jonathan Caliguire | <https://unsplash.com/photos/Ycuvvz_Px8c> (recorte horizontal) | Unsplash |

## Notas de honestidad

- **Gallo pinto, casado y café** se eligieron para que se vean ticos: gallo pinto con huevo
  frito; arroz y frijoles negros con carne mechada y plátano maduro; café colado en bolsita de
...
- **Descripciones ajustadas a la foto:** gallo pinto (huevos fritos, patacones, banano y pan
  casero), panqueques (miel, banano y fresas), frutas (sin granola), casado (sin ensalada ni
  picadillo, que no salen en la foto), lomito (sin puré) y bowl (sin palmito).
- La portada anterior (una terraza frente al mar) no correspondía a una soda de barrio: se
  reemplazó por la foto de un desayuno tico.
